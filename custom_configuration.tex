...
\supervisorBsLastname{Marchetti}
\supervisorBsFirstname{Giovanni Luca}
\supervisorBsEmail{glma@kth.se}
% If the supervisor is from within KTH add their KTHID, School and Department info
\supervisorBsKTHID{u193ut7p}
\supervisorBsSchool{\schoolAcronym{EECS}}
\supervisorBsDepartment{Intelligent Systems}
